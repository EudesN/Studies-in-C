...
for(len2 = 0; palavra2[len2] != '\0'; len2++);
    ...
    for (int i = 0; i < len1; i++){
        ...
        if (palavra1[i] == palavra2[cont]){
            ...
            if (len2 == cont) {  /*Se o contador cont atingir o tamanho da palavra2, significa que todos os caracteres da palavra2 foram encontrados em sequência dentro da palavra1.*/
